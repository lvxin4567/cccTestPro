...
var n, a = arguments.length, r = a < 3 ? t : null === o ? o = Object.getOwnPropertyDescriptor(t, s) : o;
if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(e, t, s, o); else for (var i = e.length - 1; i >= 0; i--) (n = e[i]) && (r = (a < 3 ? n(r) : a > 3 ? n(t, s, r) : n(t, s)) || r);
return a > 3 && r && Object.defineProperty(t, s, r), r;
};
Object.defineProperty(s, "__esModule", {
value: !0
});
var a = cc._decorator, r = a.ccclass, i = a.property, l = function(e) {
o(t, e);
function t() {
...
var a = e("./UpdatePanel"), r = cc._decorator, i = r.ccclass, l = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.panel = null;
...
console.log("manifestpath", e);
jsb.fileUtils.isFileExist(e) ? console.log(jsb.fileUtils.getStringFromFile(e)) : console.log("project.manifest has not found");
this._am = new jsb.AssetsManager("", this._storagePath, this.versionCompareHandle);
var t = this.panel;
this._am.setVerifyCallback(function(e, s) {
var o = s.compressed, n = s.md5, a = s.path;
s.size;
if (o) {
t.info.string = "Verification passed : " + a;
return !0;
}
t.info.string = "Verification passed : " + a + " (" + n + ")";
return !0;
});
...
var a = parseInt(s[n]), r = parseInt(o[n] || 0);
if (a !== r) return a - r;
}
...
n([ l(a.default) ], t.prototype, "panel", void 0);
